 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Dezhi Fang");
		  toPrint += p1.toString("gburdell1");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Ryan He");
		  toPrint += p2.toString("zhe66");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Zhen Liu");
          toPrint += p3.toString("zliu327");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Muchen Wu");
                  toPrint += p4.toString("mwu71");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("LirenYu");
                  toPrint += p5.toString("lyu61");
                  //Person6 replace P4 with your name
                  //and gburdell6 with your gt id
                  Person5 p6 = new Person6("P6");
                  toPrint += p6.toString("wxian3");
